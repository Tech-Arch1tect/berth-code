...
export class ApiClient {
    ...
    private setupHttpsAgent(): void {
        const config = vscode.workspace.getConfiguration('berth');
        const trustSelfSigned = config.get<boolean>('trustSelfSignedCertificates', true);
    ...
    public async get(endpoint: string, additionalHeaders?: Record<string, string>): Promise<Response> {
        return this.request('GET', endpoint, undefined, additionalHeaders);
    }

    public async post(endpoint: string, body?: any, additionalHeaders?: Record<string, string>): Promise<Response> {
        return this.request('POST', endpoint, body, additionalHeaders);
    }

    public async put(endpoint: string, body?: any, additionalHeaders?: Record<string, string>): Promise<Response> {
        return this.request('PUT', endpoint, body, additionalHeaders);
    }

    public async delete(endpoint: string, additionalHeaders?: Record<string, string>): Promise<Response> {
        return this.request('DELETE', endpoint, undefined, additionalHeaders);
    }

    public async deleteWithBody(endpoint: string, body?: any, additionalHeaders?: Record<string, string>): Promise<Response> {
    ...
    public async postMultipart(endpoint: string, file: File, fieldName: string = 'file'): Promise<Response> {
        const url = `${this.baseUrl}${endpoint}`;
